    ...
    <div class="panel-body bg-light">
       <!--  <div class="section-divider mt20 mb40">
        ...
        <div class="row" id="spy1">   
            ...
            <div class="col-md-4">
                <?= $form->field($model, 'description')->textInput(['placeholder'=>'Description','maxlength' => true])->label(FALSE) ?>  
            </div>
        </div>    
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <?php foreach ($modelsJournalItems as $i => $modelsJournalItems): ?>
                    ...
                    <div class="row">
                                <div class="col-sm-7" style="text-align: center; background-color: #185fb3; color:#fff; padding: 10px;">Account</div>
                                <div class="col-sm-2" style="text-align: center; background-color: green; color:#fff; padding: 10px;">Dr</div>
                                <div class="col-sm-2" style="text-align: center; background-color: orange; color:#fff; padding: 10px;">Cr</div>
                    </div>
                    ...
                    <div class="item"><!-- widgetBody -->   
                            ...
                            <div class="row">
                                <div class="col-sm-3 ">
                                    ...
                                    echo $form->field($modelsJournalItems, "[{$i}]chart_of_acc_id")->widget(Select2::classname(), [
                                        'data' => ArrayHelper::map(CaGroup::find()->select(['id', 'concat(item_name, " (", code, ")") AS item_name'])->andWhere(['=','ca_level', 3])->all(), 'id', 'item_name'),
                                        'language' => 'en',
                                        'options' => ['placeholder' => 'Select Account', 'class' => 'journal-create-category'],
                                        'pluginOptions' => [
                                            'allowClear' => true,
                                        ],
                                    ])->label(false);
                                ...
                                <!--div class="col-sm-2">
                                    <?php //$form->field($modelsJournalItems, "[{$i}]quantity")->textInput(['maxlength' => true,'placeholder'=>'Quantity'])->label(FALSE) ?>
                                    </div-->
                                <!--div class="col-sm-2">
                                    <?php //$form->field($modelsJournalItems, "[{$i}]unit_price")->textInput(['maxlength' => true,'placeholder'=>'Unit Price'])->label(FALSE) ?>
                                </div-->

                                <div class="col-sm-2 ">
                                    <?= $form->field($modelsJournalItems, "[{$i}]line_total_D")->textInput(['maxlength' => true, 'id'=>'journaldetail-' . $i . '-dr', 'placeholder'=>'Amount', 'class' => 'dr form-control text-right number', 'onkeyup' => 'addCommas()', 'onchange' => 'getTotAmount($(this))'])->label(FALSE) ?>
                                </div>
                                

                                <div class="col-sm-2 ">
                                    <?= $form->field($modelsJournalItems, "[{$i}]line_total_C")->textInput(['maxlength' => true, 'id'=>'journaldetail-' . $i . '-cr', 'placeholder'=>'Amount', 'class' => 'cr form-control text-right number', 'onkeyup' => 'addCommas()', 'onchange' => 'getTotAmount($(this))'])->label(FALSE) ?>
                                </div>                                

                                <div class="pull-right">
                                    <!-- <button type="button" onclick="$('.item').load(document.URL +  ' .item');">ref</button> -->
                                    <!-- <?php $form->field($modelsJournalItems, "[{$i}]refresh",['template'=>'<button type="button" class="btn btn-primary"><i class="fa fa-refresh">{input}</i></button>'])->textInput(['onclick' => "alert($(this).attr('id'));"])->label(FALSE) ?> -->
            ...
            <div class="row">
                ...
                <div class="col-sm-2" style="text-align: right; color:green; padding: 10px; font-weight:bold;"><p id="total_dr"><u></u></p></div>
                <div class="col-sm-2" style="text-align: right; color:green; padding: 10px; font-weight:bold;"><p id="total_cr"><u></u></p></div>
            </div>
        ...
        <script type="text/javascript">
            ...
            function getTotAmount(amount){
                ...
                var arr_dr_amount = document.getElementsByClassName("dr");
                var arr_cr_amount = document.getElementsByClassName("cr");

                for (var i = arr_dr_amount.length - 1; i >= 0; i--) 
                {
                    total_dr = total_dr + Number(arr_dr_amount[i].value.replace(/,/g, ""));
                }

                for (var j = arr_cr_amount.length - 1; j >= 0; j--) 
                {
                    total_cr = total_cr + Number(arr_cr_amount[j].value.replace(/,/g, ""));
                }
                ...
                if(total_cr == total_dr)
                {
                    var cr=document.getElementById("total_cr");
                    var dr=document.getElementById("total_dr");
                    cr.style.color="green";
                    dr.style.color="green";
