			...
			<table class="table">
				...
				<?php	
					foreach ($parents as $parent) 
					{
						...
						echo "<tr><th style='font-weight: bold;'>TOTAL ".strtoupper($parent_name)."</th>";
					...
					echo "<tr style='border-bottom: 5px double #000; font-weight: bold;'><th>Profit/Loss before Income Tax</th>";
					$x1 = '1';
